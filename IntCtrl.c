...
void Timer0ACapture_init         (void)
{
  ...
  GPIOPCTL_PORTB_R                      &= ~0x0F000000                ;  /* configure PB6 for T0CCP0 ,capture pin for timer0 we get this from table functions and the value for it */
  GPIOPCTL_PORTB_R                      |= 0x07000000                 ;  /*the value is 7 from the table to enable T0CCP0*/
	...
	GPTMCTL_Timer_0_R                     |= (1<<3)|(1<<2)              ;  /* capture rising and falling edges on PB6 pin */
